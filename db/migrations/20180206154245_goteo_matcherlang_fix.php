...
class GoteoMatcherlangFix
{
  ...
  public function getUpSQL()
  {
     ...
     return "
      ...
      ALTER TABLE `matcher_lang` CHANGE `lang` `lang` VARCHAR(2) CHARSET utf8 COLLATE utf8_unicode_ci NOT NULL, DROP PRIMARY KEY, ADD UNIQUE INDEX (`id`, `lang`);
     ";
  }
  ...
  {
     return "ALTER TABLE `matcher_lang` CHANGE `lang` `lang` VARCHAR(2) CHARSET utf8 COLLATE utf8_unicode_ci NULL, ADD PRIMARY KEY (`id`), DROP INDEX `id`;";
  }
